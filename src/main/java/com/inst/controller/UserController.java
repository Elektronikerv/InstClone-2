...
//		TODO move to the default constuctor
	...
	public String mainPage(@AuthenticationPrincipal User user, Model model) {
		...
		List<Image> images = imageService.findAllFollowingImages(user);
